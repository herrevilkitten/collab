...
public class UserWeb {
    ...
    private static final String OAUTH_CLIENTID_KEY = "collab.oauth.google.clientId";
    private static final String OAUTH_CLIENTSECRET_KEY = "collab.oauth.google.clientSecret";
    private static final String OAUTH_REDIRECTURL_KEY = "collab.oauth.google.redirectUrl";
    ...
    public CollabResponse signIn(OAuthSignin signin, @Context HttpServletRequest request) throws IOException, SQLException {
        ...
        User user = userDao.getByProvider(ProviderType.GOOGLE, gplusId);
        if (user == null) {
