...
public class PostgresProviderDao implements ProviderDao {
    ...
    public Provider getById(Integer id) throws SQLException {
        Statement statement = new Statement(config.getString("gitboard.private.database.sql.provider.getById"));
    ...
    public Provider getByName(String name) throws SQLException {
        Statement statement = new Statement(config.getString("gitboard.private.database.sql.provider.getByName"));
