...
public class PostgresqlUserDao implements UserDao {
    ...
    public User getById(Integer id) {
        Statement statement = new Statement(config.getString("collab.private.database.sql.account.getById"));
    ...
    public User getByProvider(ProviderType providerType, String providerAccountId) {
        Statement statement = new Statement(config.getString("collab.private.database.sql.account.getByProvider"));
    ...
    public User add(User user) {
        Statement statement = new Statement(config.getString("collab.private.database.sql.account.addAccount"));
