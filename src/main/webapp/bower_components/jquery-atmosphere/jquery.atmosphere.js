...
(function(factory) {
    ...
    jQuery.atmosphere = {
        ...
        AtmosphereRequest: function (options) {
            ...
            /**
             * The Heartbeat interval send by the application.
             * @type {int}
             * @private
             */
            ...
            /**
             * The Heartbeat bytes send by the application.
             * @type {string}
             * @private
             */
            ...
            /**
             * Check if application side events (SSE) is supported (check for custom implementation provided by request object or browser implementation).
             *
             * @returns {boolean} True if web socket is supported, false otherwise.
             * @private
             */
                    ...
                    if (reason === "") {
                        switch (message.code) {
                            case 1000:
                                ...
                                break;
                            case 1001:
                                reason = "The endpoint is going away, either because of a application failure or because the "
            ...
            function _handleProtocol(request, message) {
                ...
                if (request.enableProtocol && request.firstMessage && jQuery.trim(message).length !== 0) {
                    ...
                    if (messages.length <= pos + 2) {
                        jQuery.atmosphere.log('error', ["Protocol data not sent by the application. " +
                            "If you enable protocol on client side, be sure to install JavascriptProtocol interceptor on application side." +
            ...
            function _configureXDR(request) {
                ...
                xdr.onerror = function () {
                    // If the application doesn't send anything back to XDR will fail with polling
                    if (rq.transport !== 'polling') {
                        _clearState();
            ...
            function _configureIE(request) {
                ...
                return {
                    open: function () {
                        ...
                        // For the application to respond in a consistent format regardless of user agent, we polls response text
